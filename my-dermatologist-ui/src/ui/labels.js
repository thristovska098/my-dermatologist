...
export const EXPIRING_DATE_LABEL = 'Card expiration date (MM/YY)';
export const CVC_LABEL = 'CVC';
export const TOTAL_COST_LABEL = 'Your total is';
...
export const INVALID_PHONE_MESSAGE = 'Invalid phone format. The phone number should contain only digits.';
export const INVALID_SSN_MESSAGE = 'Invalid SSN length. The SSN should have 13 characters.';
export const INVALID_DATE = 'Invalid date. The date should be in the past.';
